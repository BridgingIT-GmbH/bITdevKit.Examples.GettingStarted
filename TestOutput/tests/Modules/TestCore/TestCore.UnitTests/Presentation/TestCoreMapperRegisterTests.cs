namespace TestOutput.Modules.TestCore.UnitTests.Presentation;
...
public class TestCoreMapperRegisterTests
{
    private readonly TypeAdapterConfig config;

    public TestCoreMapperRegisterTests()
    {
        this.config = new TypeAdapterConfig();
        new TestCoreMapperRegister().Register(this.config);
    }
