...
/// for the TestCore, using a convention-based connection string key.
/// </summary>
public class CoreDbContextFactory : ModuleDbContextFactory<CoreDbContext>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CoreDbContextFactory"/> class with settings specific to TestCore.
