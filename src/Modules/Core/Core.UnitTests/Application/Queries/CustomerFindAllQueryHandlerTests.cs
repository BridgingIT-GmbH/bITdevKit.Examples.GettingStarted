...
namespace BridgingIT.DevKit.Examples.GettingStarted.Modules.Core.UnitTests.Application.Queries;

using BridgingIT.DevKit.Domain.Repositories;
using BridgingIT.DevKit.Examples.GettingStarted.Modules.Core.Application.Queries;
