...
namespace BridgingIT.DevKit.Examples.GettingStarted.Modules.Core.Domain.Model;

using BridgingIT.DevKit.Domain.Model;
using BridgingIT.DevKit.Examples.GettingStarted.Modules.Core.Domain.Events;
