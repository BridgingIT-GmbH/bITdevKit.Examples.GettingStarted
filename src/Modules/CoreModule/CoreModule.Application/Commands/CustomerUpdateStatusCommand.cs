...
/// <param name="statusId">Target status identifier (Enumeration Id).</param>
public class CustomerUpdateStatusCommand(string customerId, int statusId) : RequestBase<CustomerModel>
{
