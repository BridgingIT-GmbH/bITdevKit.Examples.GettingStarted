...
**If no integrations are detected:** Suggest they can enable connectors or integrations in their Agent settings to allow pulling context from messaging apps and document storage directly.
...
- If user mentions team channels or shared documents:
  ...
  - If integrations not available: Explain lack of access. Suggest they enable connectors in the Agnet settings, or paste the relevant content directly.
...
Create a file with all section headers and brief placeholder text like "[To be written]" or "[Content here]".
...
- Confirm edits are complete and ask for further feedback
...
Ask what questions people might ask when trying to discover this document. What would they type into an Agent?
...
- Confirm file updates after every change
