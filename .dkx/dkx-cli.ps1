...
$categories = [ordered]@{
  ...
  'Utilities'                 = @('misc-clean', 'misc-digest', 'misc-repl', 'misc-kill-dotnet', 'misc-browser-seq', 'misc-browser-adminneo', 'misc-browser-server-kestrel', 'misc-browser-server-docker')
