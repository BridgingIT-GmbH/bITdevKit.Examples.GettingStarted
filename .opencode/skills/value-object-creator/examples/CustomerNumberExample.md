...
This example shows a complex value object with regex validation and multiple factory methods.

## Key Features

- Value object with custom validation logic
- Demonstrates business rule validation
- Shows error message customization
