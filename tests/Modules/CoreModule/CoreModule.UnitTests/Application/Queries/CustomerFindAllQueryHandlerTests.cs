...
/// <summary>
/// Tests for <see cref="CustomerFindAllQuery"/> validating customer retrieval scenarios.
/// </summary>
[UnitTest("Application")]
public class CustomerFindAllQueryTests(ITestOutputHelper output) : CoreModuleTestsBase(output)
{
